            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <span class="error" data-testid="file-error-msg" aria-live="polite" style="color: red;"></span>
                  </div>
                </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="col-half">
                  <button type="submit" id='btn-send-bill' data-testid="envoyer-btn"  class="btn btn-primary">Envoyer</button>
                </div>
              </div>
            </div>
          </form>
